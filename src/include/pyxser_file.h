...
#ifndef PYXSER_FILE_H
#define PYXSER_FILE_H 1
...
#if 0
	PyObject *pyxser_SerializeExactFile(PyxSerDeserializationArgsPtr obj);
	PyObject *pyxser_SerializeFile(PyxSerDeserializationArgsPtr obj);
