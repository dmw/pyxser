...
##
## $Id: test-utf8.py 162 2010-08-22 22:07:13Z damowe $
##
...
def test_normal(test):
    try:
        ...
        print "Serilized Object Validation:\n", \
              ...
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        unserialized = pyxser.unserialize(obj = serialized, enc = "iso-8859-1")
        print "Unserialized Object (d.2):\n" + repr(unserialized) + "\n\n"

        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 3)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 4)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 5)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
...
def test_selector(test):
    try:
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 2, selector = sel)
        print "Serilized Object:\n", serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 3, selector = sel)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 4, selector = sel)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 5, selector = sel)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 0, selector = sel)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
...
def test_normal_c14n(test):
    try:
        ...
        print "First Object:\n" + repr(test) + "\n\n"
        print "Serilized Object Validation:\n", \
              pyxser.validate_c14n(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_c14n_dtd(obj = serialized, enc = "iso-8859-1")
        unserialized = pyxser.unserialize(obj = serialized, enc = "iso-8859-1")
...
def test_unicode(test):
    try:
        ...
        serialized = pyxser.u_serialize(obj = test, enc = "iso-8859-1", depth = 2)
        print "Serilized Object:\n", serialized.encode("iso-8859-1")
        print "Serilized Object Validation:\n", \
              pyxser.u_validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.u_validate_dtd(obj = serialized, enc = "iso-8859-1")
        unserialized = pyxser.u_unserialize(obj = serialized, enc = "iso-8859-1")
        print "Unserialized Object (d.2):\n" + repr(unserialized) + "\n\n"

        serialized = pyxser.u_serialize(obj = test, enc = "iso-8859-1", depth = 3)
        print "Serilized Object:\n" + serialized.encode("iso-8859-1")
        print "Serilized Object Validation:\n", \
              pyxser.u_validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.u_validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.u_serialize(obj = test, enc = "iso-8859-1", depth = 4)
        print "Serilized Object:\n" + serialized.encode("iso-8859-1")
        print "Serilized Object Validation:\n", \
              pyxser.u_validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.u_validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.u_serialize(obj = test, enc = "iso-8859-1", depth = 5)
        print "Serilized Object:\n" + serialized.encode("iso-8859-1")
        print "Serilized Object Validation:\n", \
              pyxser.u_validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.u_validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.u_serialize(obj = test, enc = "iso-8859-1", depth = 0)
        print "Serilized Object:\n" + serialized.encode("iso-8859-1")
        print "Serilized Object Validation:\n", \
              pyxser.u_validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.u_validate_dtd(obj = serialized, enc = "iso-8859-1")
...
def test_unicode_c14n(test):
    try:
        ...
        print "First Object:\n" + repr(test) + "\n\n"
        print "Serilized Object Validation:\n", \
              pyxser.u_validate_c14n(obj = serialized, enc = "iso-8859-1"), \
              pyxser.u_validate_c14n_dtd(obj = serialized, enc = "iso-8859-1")
...
def test_typemap(test):
    try:
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 2, typemap = test_typemap_map)
        print "Serilized Object:\n", serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        unserialized = pyxser.unserialize(obj = serialized, enc = "iso-8859-1", typemap = test_typemap_map)
        print "Unserialized Object (d.2):\n" + repr(unserialized) + "\n\n"

        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 3, typemap = test_typemap_map)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 4, typemap = test_typemap_map)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 5, typemap = test_typemap_map)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        ...
        serialized = pyxser.serialize(obj = test, enc = "iso-8859-1", depth = 0, typemap = test_typemap_map)
        print "Serilized Object:\n" + serialized
        print "Serilized Object Validation:\n", \
              pyxser.validate(obj = serialized, enc = "iso-8859-1"), \
              pyxser.validate_dtd(obj = serialized, enc = "iso-8859-1")
        unserialized = pyxser.unserialize(obj = serialized, enc = "iso-8859-1",
                                          typemap = test_typemap_map, cinit = False)
        print "Unserialized Object (d.0):\n" + repr(unserialized) + "\n\n"
